...
- **GPU Backend**: `uv sync --extra gpu` *(Requires the system CUDA 13.x toolkit; uses `cupy-cuda13x`)*
- **Visualization**: `uv sync --extra viz`
- **Docs**: `uv sync --extra docs`
- **Dev tooling**: `uv sync --group dev`
- **Everything**: `uv sync --all-extras --group dev`
