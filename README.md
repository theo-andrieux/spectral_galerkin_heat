...
fastHeatSolv is built around the **Abstract Factory pattern**, isolating physical computation kernels (`HeatSolver`) from data telemetry (`IOManager`). See the [Architecture Guide](docs/ARCHITECTURE.md) for understanding how the loop works.
